...
let Aux1_C:boolean= true == true;
let Aux2_C:boolean= false == false;
let Aux3_C:Boolean = Aux1_C && !Aux2_C;
let Aux4_C:boolean= true == true;
let Aux5_C:boolean= false == false;
let Aux6_C:Boolean = !Aux1_C && !Aux2_C;
let Aux7_C:Boolean = Aux4_C && Aux6_C;
if (Aux7_C) {
...
Aux1_C=false == false;
Aux2_C=true == false;
Aux3_C=Aux1_C && Aux2_C;
if (Aux3_C && "Industrial" != "Sistemas" && 5 * 5 == 5 ** 2) {
